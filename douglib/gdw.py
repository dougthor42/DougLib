...
# Copied from douglib.core, thus removing the only dependency on douglib.core
# The problem is that douglib.core import scipy, and scipy doesn't play
# nicely with cx_freeze
